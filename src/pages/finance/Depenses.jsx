      ...
      <div id="depenses-print">
        ...
        <div className="app-card">
          <div className="p-5 border-b flex items-center justify-between">
            <div>
              <h2 className="text-xl font-bold flex items-center gap-2"><Wallet size={20} color="#16a34a" strokeWidth={2.3} /> Dépenses</h2>
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-slate-50">
                <tr>{['Date','Catégorie','Description','Mode', otrMode ? 'Montant (masqué)' : 'Montant',''].map(h => (
              ...
              <tbody>
                ...
                {!depsFiltered.length && (
                  <tr><td colSpan={6} className="text-center text-slate-400 py-8 text-sm">Aucune dépense</td></tr>
                )}
              </tbody>
            </table>
          </div>
